...
import com.unity.model.ExceptionItem;
import com.unity.model.MethodParameter;
import com.unity.model.Return;
...
public class ClassItemsLookupTest {
    ...
    public void convertFullNameToOverload() {
        assertThat("Wrong result", classItemsLookup.convertFullNameToOverload(
            "com.unity.samples.SuperHero.successfullyAttacked(int,java.lang.String)"), is(
            "com.unity.samples.SuperHero.successfullyAttacked*"));

        assertThat("Wrong result for case with generics", classItemsLookup.convertFullNameToOverload(
            "com.unity.samples.subpackage.Display<T,R>.show()"), is(
            "com.unity.samples.subpackage.Display<T,R>.show*"));

        assertThat("Wrong result for constructor case", classItemsLookup.convertFullNameToOverload(
            "com.unity.samples.SuperHero.SuperHero()"), is(
            "com.unity.samples.SuperHero.SuperHero*"));
    }
