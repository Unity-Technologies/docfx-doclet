...
public class BaseLookupTest {
    ...
    @Test
    public void resolve() {
        TypeElement element1 = elements.getTypeElement("com.unity.samples.subpackage.Person");
        TypeElement element2 = elements.getTypeElement("com.unity.samples.subpackage.Display");
