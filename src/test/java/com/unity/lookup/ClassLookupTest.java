...
import com.unity.model.TypeParameter;
...
public class ClassLookupTest {
    ...
    public void determineTypeParameters() {
        TypeElement element = elements.getTypeElement("com.unity.samples.subpackage.Person");
    ...
    public void determineSuperclassForChildClass() {
        TypeElement element = elements.getTypeElement("com.unity.samples.SuperHero");

        String result = classLookup.determineSuperclass(element);

        assertThat("Wrong result", result, is("com.unity.samples.subpackage.Person"));
    }

    @Test
    public void determineSuperclassForEnum() {
        TypeElement element = elements
            .getTypeElement("com.unity.samples.subpackage.Person.IdentificationInfo.Gender");

        String result = classLookup.determineSuperclass(element);

        assertThat("Wrong result", result,
            is("java.lang.Enum<com.unity.samples.subpackage.Person.IdentificationInfo.Gender>"));
    }
    ...
    public void determineClassContentForInterface() {
        TypeElement element = elements.getTypeElement("com.unity.samples.subpackage.Display");
        ExtendedMetadataFileItem container = new ExtendedMetadataFileItem("UID");
        ...
        assertThat("Wrong set of interfaces", container.getInterfaces(),
            hasItems("java.io.Serializable", "java.util.List<com.unity.samples.subpackage.Person<T>>"));
    }
    ...
    public void determineClassContentForStaticClass() {
        TypeElement element = elements.getTypeElement("com.unity.samples.subpackage.Person.IdentificationInfo");
        ExtendedMetadataFileItem container = new ExtendedMetadataFileItem("UID");
